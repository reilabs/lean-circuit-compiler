...
// CodeExtractor implements the `ExtractorApi` in
// order to have user flexibility in the arguments
// supplied to the public function in `interface.go`
// CodeExtractor implements all the operations
// supported by `proven-zk`
